...
SECRET_KEY = 'django-insecure-a6pt_($%+9(nrtpd(z(!jx)d%39l=6_y02c^4*$1ua0x)atd=e'
...
MEDIA_URL = '/media/'
# implementing css for register and login form using bootstrap4
CRISPY_ALLOWED_TEMPLATE_PACKS = 'bootstrap4'
CRISPY_TEMPLATE_PACK = 'bootstrap4'
# after user logs in redirect to home page
